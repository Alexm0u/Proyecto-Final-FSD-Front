...
<Row>
        ...
        <h4>Scoobike</h4>
        <p> <i class="bi bi-geo-alt"></i> C/Serrería, 13</p>
        <p> <i class="bi bi-globe-europe-africa"></i> 46011, Valencia</p>
        </Col>
    <Col className='margin mt-2'>
        <h4>Contact</h4>
        <p> <i class="bi bi-telephone"></i> +34 123 456 789 </p>
        <p> <i class="bi bi-envelope-open-heart"></i> info@scoobike.com </p>
        </Col>
    <Col className='margin mt-2'>
            <h4>Horario</h4>
